        ...
        [
            ...
            A.OneOf(
                [
                    ...
                    A.PadIfNeeded(
                        min_height=image_size[0], min_width=image_size[1], p=p
                    ),
                ],
                p=1,
            ),
            ...
            A.OneOf(
                [
                    A.ElasticTransform(
                        alpha=120, sigma=120 * 0.05, alpha_affine=120 * 0.03, p=p
                    ),
                    A.GridDistortion(p=p),
                    A.OpticalDistortion(distort_limit=2, shift_limit=p, p=1),
                ],
                p=0.8,
            ),
        ]
